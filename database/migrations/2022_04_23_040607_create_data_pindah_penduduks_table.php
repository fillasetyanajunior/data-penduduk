...
class CreateDataPindahPenduduksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('data_pindah_penduduks', function (Blueprint $table) {
            $table->id();
            $table->string('nkk');
            $table->string('nik');
            $table->string('nama');
    ...
    {
        Schema::dropIfExists('data_pindah_penduduks');
    }
}
