...
class DataPindahPendudukController extends AppController
{
    public function index()
    {
        ...
        return view('admin.pindahpenduduk.pindahpenduduk', compact('title'));
    }
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('message', 'Data Pindah Penduduk Berhasil Ditambahkan');
    }
}
