<header class="navbar navbar-expand-md navbar-light d-print-none">
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
            <a href="?theme=dark" class="nav-link me-3 px-0 hide-theme-dark" title="Enable dark mode"
            ...
            <a href="?theme=light" class="nav-link me-3 px-0 hide-theme-light" title="Enable light mode"
                data-bs-toggle="tooltip" data-bs-placement="bottom">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
                    stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    <span class="avatar avatar-sm" style="background-image: url({{url('dist/img/default.png')}})"></span>
        ...
        <div class="navbar navbar-light">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item @if ($title == 'Daftar Calon') active @endif">
                        <a class="nav-link" href="{{route('voterlist.managemen')}}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <li class="nav-item @if ($title == 'Management User Pemilih') active @endif">
                        <a class="nav-link" href="{{route('managementuser')}}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
